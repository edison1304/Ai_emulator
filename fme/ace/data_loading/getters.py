...
def get_gridded_data(
    ...
    if config.zarr_engine_used:
        ...
        mp_context = "spawn"  # Use spawn for better stability
    ...
    dataloader = get_data_loader(
        ...
        shuffled=train,
        drop_last=True,
        pin_memory=False,  # Disabled to avoid pin memory thread issues
...
def get_inference_data(
    ...
    # Torch only allows prefetch_factor when num_workers>0; leave unset otherwise
